 ...
 */
declare type ListrEventFromType<
  T extends ListrEventType,
  E = ListrEvent
> = E extends {
  type: infer U;
}
...
declare type PromptOptionsType<T> = T extends keyof PromptOptionsMap
  ...
  : any;
declare class PromptOptionsMap
  implements Record<PromptTypes, Record<PropertyKey, any>>
{
...
interface PromptSettings {
  ...
  ) => string | Error | PromptError | void;
  stdout?: WriteStream | Writable;
  enquirer?: Enquirer;
}
interface PromptInstance
  extends Omit<BasePromptOptions, "onCancel" | "onSubmit"> {
  submit: () => void;
...
declare class DefaultRenderer implements ListrRenderer {
  ...
  getSelfOrParentOption<
    T extends keyof (typeof DefaultRenderer)["rendererOptions"]
  >(
    task: Task<any, typeof DefaultRenderer>,
    key: T
...
declare class SimpleRenderer implements ListrRenderer {
  ...
  eventTypeRendererMap: Partial<{
    [P in ListrEventType]: (
      t: Task<any, typeof SimpleRenderer>,
      event: ListrEventFromType<P>
    ) => void;
  }>;
  constructor(
 ...
 */
declare type ListrGetRendererClassFromValue<T extends ListrRendererValue> =
 ...
 */
declare type ListrGetRendererValueFromClass<T extends ListrRendererFactory> =
 ...
 */
declare type ListrGetRendererOptions<T extends ListrRendererValue> =
  T extends ListrDefaultRendererValue
 ...
 */
declare type ListrGetRendererTaskOptions<T extends ListrRendererValue> =
  T extends ListrDefaultRendererValue
...
declare function destroyPrompt(
  this: TaskWrapper<any, any>,
  throwError?: boolean
): void;
